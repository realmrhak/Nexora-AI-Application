...
const ChatInterface = () => {
  ...
  if (initialLoading) {
    return (
      // ✅ FIXED: h-[500px] fixed height, no percentage
      <div className="flex flex-col h-[500px] bg-white rounded-xl items-center justify-center shadow-sm w-full">
  ...
  return (
    ...
    <div className='flex flex-col h-[500px] sm:h-[600px] bg-white rounded-xl shadow-sm overflow-hidden w-full'>
